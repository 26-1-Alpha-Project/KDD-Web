  ...
  return (
    <div className="flex items-center gap-4 rounded-[28px] border border-gray-100 bg-white px-5 py-3 shadow-[0px_2px_12px_0px_rgba(0,0,0,0.08)] md:gap-6 md:px-9">
      <textarea
        ...
        rows={1}
        className="max-h-40 flex-1 resize-none overflow-y-auto scrollbar-none bg-transparent text-base leading-6 text-foreground outline-none field-sizing-content placeholder:text-[#99a1af]"
      />
      <button
        onClick={handleSend}
        disabled={!canSend}
